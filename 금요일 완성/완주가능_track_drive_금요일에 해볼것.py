...
def sonic_drive():
    ...
    elif (0 < ultra_msg[2] < 70  and ultra_msg[3]-ultra_msg[1] > 10):
        new_angle = 80
        new_speed = 15
        print("Car Brake, Stop! : ", ultra_msg)
...
def move_car(move_angle, speed, X):
    for i in range(X): 
        drive(angle=move_angle, speed = speed ) # 18
        time.sleep(0.01)
...
def start():
    ...
    drive_mode = LANE_DRIVE  #TRAFFIC_SIGN   # SENSOR_DRIVE
    ...
    while not rospy.is_shutdown():
        ...
        while drive_mode == LANE_DRIVE:
            ...
            if found:
                ...
                if abs(new_angle) < 10:
                    new_speed =  Fix_Speed + 6
                elif abs(new_angle) > 40 :  ##  이거는 나중에 해보자
                    new_speed = Fix_Speed - 6
        ...
        while drive_mode == AR_DRIVE:
            ...
            if found:
                ...
                drive(new_angle,new_speed = 24) #### fifiten
                retry_count = 0
        ...
        while drive_mode == OBJECT_DETECT:
            ...
            if (object_position == -1):
                ...
                move_car(move_angle = -100, speed = 24, X = 100)
                # move_car(move_angle =  0,  speed = 18)
                move_car(move_angle =  100,  speed = 20, X = 100)
                drive_mode = PARKING
...
#  차이점은 위애서 2번 테그에서 중간 과정 생략 그래서 인식거리 줄임
...
#     # AR태그가 인식되었으면 적절하게 핸들을 꺾어 주행합니다. 
#     print("AR drive", new_angle)
#     drive(new_angle,new_speed = 24) #### fifiten    21 -> 24
#     retry_count = 0
...
# elif (0 < ultra_msg[2] < 70  and ultra_msg[3]-ultra_msg[1] > 10):   -> 여기 코드 추가함 -> 거리가 가까워 지고 차이가 나면 느리게 가게 하려고
#     new_angle = 80
#     new_speed = 15
#     print("Car Brake, Stop! : ", ultra_msg)
...
# # 오른쪽이 왼쪽보다 멀리 있으면 있으면 우회전 주행
# elif (ultra_msg[3]-ultra_msg[1] > 10): 
#     new_angle = 40                           -> 여기도 줄임 동등하게 가게 하려고 -> 괜찮은 움직임이 나오면 속도 올려서 해보자
#     new_speed = Fix_Speed
#     print("Turn left1 : ", ultra_msg)
