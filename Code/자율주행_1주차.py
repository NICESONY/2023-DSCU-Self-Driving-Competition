...
def sonic_drive():
    ...
    # elif (ultra_msg[1] - ultra_msg[3] > 15):
    #     new_angle = -40
    #     new_speed = Fix_Speed
	# print("Turn left : ", ultra_msg)
     
    # elif (ultra_msg[3] - ultra_msg[1] > 15):
    #     new_angle = 40
    #     new_speed = Fix_Speed
	# print("Turn right : ", ultra_msg)
...
def check_stopline():
    ...
    stopline_check_img = binary_img[70:110, 150:440]  
    ...
    cv2.rectangle(img, (150,70),(440,110),Green,3)  ###
...
def sonic_drive():
    ...
    # elif (ultra_msg[1] - ultra_msg[3] > 10):  ###### 변경해보자 ########### 테스트
    #     new_angle = -30
    #     new_speed = Fix_Speed
    ...
    #     new_speed = Fix_Speed
            ...
            ################################ 신호등 인식, 객체인식, 주차 질문하고 1. 코드 추가하는 법 2. launch 파일에 대한 이해 
...
while not rospy.is_shutdown():
    ...
    # cimg(원본이미지)의 특정영역(ROI Area)을 잘라내기
    cimg = image.copy()
    ...
    circles = cv2.HoughCircles(blur, cv2.HOUGH_GRADIENT, 1, 20, 
                  param1=40, param2=20, minRadius=15, maxRadius=25) ######here

    # Show Canny image for debugging
    canny = cv2.Canny(blur, 20, 40)  #### here######
...
rospy.init_node('cam_tune', anonymous=True) #########
rospy.Subscriber("/usb_cam/image_raw/", Image, img_callback) ###333333넣음
rospy.wait_for_message("/usb_cam/image_raw/", Image)  #####
...
while not rospy.is_shutdown():
	...
	#  #####roslaunch my_traffic traffic_sign_check.launch####
