...
def ultra_callback(data):
    ...
    ultra_list = [int(ultra_mvavg[i].get_mavg()) for i in range(8)]
...
def sonic_drive():
    ...
    # 왼쪽이 오른쪽보다 멀리 있으면 있으면 좌회전 주행
    # elif (ultra_msg[1]-ultra_msg[3] > 20):
        # new_angle = -100
        # new_speed = Fix_Speed
        # print("Turn left1 : ", ultra_msg)

    # 오른쪽이 왼쪽보다 멀리 있으면 있으면 우회전 주행
    # elif (ultra_msg[3]-ultra_msg[1] > 20):
        # new_angle = 100
        # new_speed = Fix_Speed
        # print("Turn left1 : ", ultra_msg)
...
def start():
    ...
    while not rospy.is_shutdown():
        ...
        while drive_mode == LANE_DRIVE:
            ...
            elif (distance < 0.5) and (ar_ID == 2): # Obejct Detection Sign
