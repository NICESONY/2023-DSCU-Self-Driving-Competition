...
def check_traffic_sign():
    ...
    cimg = image.copy()
    Center_X, Center_Y = 300, 120  # ROI 영역의 중심위치 좌표 
    XX, YY = 60, 35  # 위 중심위치 좌표에서 좌우로 XX만큼씩, 상하로 YY만큼씩 벌려서 ROI 영역을 잘라냄   
...
def start():
    ...
    while not rospy.is_shutdown():
        ...
        while drive_mode == LANE_DRIVE:
            ...
            elif (distance < 0.9) and (ar_ID == 2): # Obejct Detection Sign
